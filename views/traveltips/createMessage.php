...
if ($user) {
?>
    <form id="messageForm" method="POST" action="<?= getUrl('traveltips/' . urlencode($countryParam) . '/createmessage')?>">
            ...
            <div class="flex-1 md:flex">
                ...
                <textarea name="message" 
                        rows="5" 
                          ...
                          maxlength="400"
                          id="messageTextarea"><?php
                              if (isset($_SESSION['errors'])) {
                                echo isset($message) ? trim($message) : '';
                            } else {
        ...
        function emptyInputMessageFunction() {
            ...
            <div>
                <button type="submit" 
                        class="py-1 px-1 bg-green-500 text-white rounded-lg shadow-md hover:bg-green-600 focus:outline-none focus:ring focus:border-green-700 opacity-30 pointer-events-none"
