...
<div class="flex h-full flex-col md:flex-row dark:bg-darkBackground dark:text-lighTextColor px-2 py:2 md:px-6 md:py-6 ">
<div class="flex  flex-col md:flex-row ">
  <div class="flex-1 text-xl">

  <p>Vítejte na našem webu <span class='dark:text-red-300 text-red-800 font-bold'><?php echo htmlspecialchars($firstName ? $firstName : ($email ? $email : 'guest')); ?>
...
<p>Nechte se inspirovat našimi stránkami a připravte se na nezapomenutelné zážitky, které vás čekají na cestách po světě!</p>
  ...
  <div class='flex flex-1 justify-center'>
    <img src="./public/lide.svg" alt="" class="float-right" />
  </div>
</div>
