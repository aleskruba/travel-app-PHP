...
if (isset($_SESSION['user'])) {
    ...
    if ($user) {
        ...
        $db->query('INSERT INTO user (firstName,lastName,image,googleProfilePicture,googleEmail,email) VALUES (:firstName,:lastName,:image,:googleProfilePicture,:googleEmail,:email )',[
            'firstName' => $givenName,
            'lastName'=> $familyName,
            'image' => $picture,
        ...
        $user = $db->query('SELECT * FROM user WHERE googleEmail = :googleEmail', ['googleEmail' => $email])->find();
